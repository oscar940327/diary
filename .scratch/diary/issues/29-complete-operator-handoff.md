...
- [ ] Runbooks cover manual production release, active/prior revision identification, failed-check diagnosis, rollback, compatible migrations, and pre-migration backup.
...
- [ ] The owner completes a guided release and rollback exercise and can identify the deployed commit SHA and previous known-good revision.
