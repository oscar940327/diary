create function public.list_diary_history_v3(
    p_anchor_date date,
    p_direction text,
...
revoke all on function public.list_diary_history_v3(
    date,
    text,
    timestamptz,
    uuid,
...
grant execute on function public.list_diary_history_v3(
    date,
    text,
    timestamptz,
    uuid,
...
comment on function public.list_diary_history_v3(
    date,
    text,
    timestamptz,
    uuid,
    ...
    'Returns snapshot-stable History pages and cursor metadata for empty anchors.';
