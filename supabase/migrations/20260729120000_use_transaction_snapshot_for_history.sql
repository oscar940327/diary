create function public.list_diary_history_v2(
    p_anchor_date date,
    p_direction text,
...
revoke all on function public.list_diary_history_v2(
    date,
    text,
    timestamptz,
    uuid,
...
grant execute on function public.list_diary_history_v2(
    date,
    text,
    timestamptz,
    uuid,
...
comment on function public.list_diary_history_v2(
    date,
    text,
    timestamptz,
    uuid,
    ...
    'Returns pages from the Entry set visible to the initial statement.';
